...
function initializeReadMore(){
    ...
    function readMoreCallBack(){
        ...
        $readMore.readmore({
            ...
            moreLink: '<a href="#" class="btn btn-primary btn-xs btn_02 btn-light-frame btn-framed btn-rounded">More<i class="icon_plus"></i></a>',
            lessLink: '<a href="#" class="btn btn-primary btn-xs btn_02 btn-light-frame btn-framed btn-rounded">Less<i class="icon_minus-06"></i></a>'
        });
    }
}
